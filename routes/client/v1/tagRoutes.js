...
const tagController = require('../../../controller/client/v1/tagController');
...
router.route('/client/api/v1/tag/:id').get(auth(PLATFORM.CLIENT),checkRolePermission,tagController.getTag);
